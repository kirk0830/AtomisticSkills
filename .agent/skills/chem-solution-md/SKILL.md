...
python .agent/skills/chem-solution-md/scripts/build_solvation_box.py \
    --solvent water \
    --num_solvent 64 \
...
```bash
# Env: base-agent
python .agent/skills/chem-solution-md/scripts/analyze_solution_md.py \
...
python .agent/skills/chem-solution-md/scripts/build_solvation_box.py \
    ...
    --output_dir .agent/skills/chem-solution-md/examples/pure_water
```
...
python .agent/skills/chem-solution-md/scripts/build_solvation_box.py \
    ...
    --output_dir .agent/skills/chem-solution-md/examples/NaCl_in_water
```
