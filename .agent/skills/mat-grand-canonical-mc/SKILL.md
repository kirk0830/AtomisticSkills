...
```bash
# Env: smol-agent
python .agent/skills/mat-grand-canonical-mc/scripts/run_gcmc_sweep.py \
...
```bash
# Env: smol-agent
python .agent/skills/mat-grand-canonical-mc/scripts/analyze_gcmc_results.py \
...
# Env: smol-agent
python .agent/skills/mat-grand-canonical-mc/scripts/run_gcmc_sweep.py \
    --ce_file .agent/skills/ml-cluster-expansion/examples/CuAg_CE/cluster_expansion.json \
    --supercell 4 4 4 \
    ...
    --element Ag \
    --output_dir .agent/skills/mat-grand-canonical-mc/examples/CuAg/gcmc_results/
```
...
# Env: smol-agent
python .agent/skills/mat-grand-canonical-mc/scripts/analyze_gcmc_results.py \
    --results_file .agent/skills/mat-grand-canonical-mc/examples/CuAg/gcmc_results/results_summary.json \
    --output_dir .agent/skills/mat-grand-canonical-mc/examples/CuAg/ \
    --element Ag
```
