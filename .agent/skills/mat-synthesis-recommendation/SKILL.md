...
```bash
# Env: base-agent
python .agent/skills/mat-synthesis-recommendation/scripts/recommend_synthesis.py "LiFePO4" --limit 10 --output synthesis_recipes.json
```
...
python .agent/skills/mat-stability/scripts/calculate_stability.py target.cif --output stability_analysis.json
...
```bash
# Env: base-agent
python .agent/skills/mat-synthesis-recommendation/scripts/recommend_synthesis.py "LiFePO4" --limit 5
```
...
python .agent/skills/mat-synthesis-recommendation/scripts/recommend_synthesis.py "LiCoO2" --type hydrothermal --limit 10 --output LiCoO2_hydrothermal.json
```
...
python .agent/skills/mat-synthesis-recommendation/scripts/recommend_synthesis.py "Li2CO3" --max-temp 600 --limit 10
```
