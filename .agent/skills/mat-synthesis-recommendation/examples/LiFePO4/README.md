...
```bash
# Env: base-agent
python .agent/skills/mat-synthesis-recommendation/scripts/recommend_synthesis.py "LiFePO4" --limit 5 --output synthesis_recipes.json
```
...
- Check thermodynamic stability: [mat-stability](../../mat-stability/SKILL.md)
- Calculate electrochemical voltage: [mat-intercalation-voltage](../../mat-intercalation-voltage/SKILL.md)
