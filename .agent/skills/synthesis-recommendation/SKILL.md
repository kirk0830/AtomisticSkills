...
```bash
# Env: base-agent
python .agent/skills/synthesis-recommendation/scripts/recommend_synthesis.py "LiFePO4" --limit 10 --output synthesis_recipes.json
```
...
# See: ../material-stability/SKILL.md
python .agent/skills/material-stability/scripts/calculate_stability.py target.cif --output stability_analysis.json
...
```bash
# Env: base-agent
python .agent/skills/synthesis-recommendation/scripts/recommend_synthesis.py "LiFePO4" --limit 5
```
...
python .agent/skills/synthesis-recommendation/scripts/recommend_synthesis.py "LiCoO2" --type hydrothermal --limit 10 --output LiCoO2_hydrothermal.json
```
...
python .agent/skills/synthesis-recommendation/scripts/recommend_synthesis.py "Li2CO3" --max-temp 600 --limit 10
```
