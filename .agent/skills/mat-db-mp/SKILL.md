...
```bash
# Env: base-agent
python .agent/skills/mat-db-mp/scripts/get_elasticity.py \
    --material_id mp-149 \
...
```bash
# Env: base-agent
python .agent/skills/mat-db-mp/scripts/get_magnetism.py \
...
```bash
# Env: base-agent
python .agent/skills/mat-db-mp/scripts/get_structure_by_id.py mp-149 \
...
```bash
# Env: base-agent
python .agent/skills/mat-db-mp/scripts/get_structure_by_id.py \
...
```bash
# Env: base-agent
python .agent/skills/mat-db-mp/scripts/find_similar_structures.py \
    --material_id mp-149 \
    --top 15 \
