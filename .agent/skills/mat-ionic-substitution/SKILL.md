...
2. **Run the forward proposal script**:
   ```bash
   # Env: base-agent
   python .agent/skills/mat-ionic-substitution/scripts/propose_substitutions.py \
...
1. **Run the reverse search script**:
   ```bash
   # Env: base-agent
   python .agent/skills/mat-ionic-substitution/scripts/find_structures_for_composition.py \
       --composition LiCl \
       --threshold 0.001 \
