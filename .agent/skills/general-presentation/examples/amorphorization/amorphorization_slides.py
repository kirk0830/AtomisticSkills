...
Usage:
    # Env: base-agent
    python .agent/skills/general-presentation/examples/amorphorization/amorphorization_slides.py
...
sys.path.insert(0, os.path.join(PROJECT_ROOT, ".agent", "skills", "general-presentation", "scripts"))
