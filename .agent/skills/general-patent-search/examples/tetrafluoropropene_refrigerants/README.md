...
python .agent/skills/general-patent-search/scripts/query_google_patents.py \
    "tetrafluoropropene OR HFO-1234yf" --limit 5 \
    --output .agent/skills/general-patent-search/examples/tetrafluoropropene_refrigerants/results.json
```
