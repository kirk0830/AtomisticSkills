...
python .agent/skills/db-chembl/scripts/query_chembl.py \
  --target "EGFR" \
  --target_type "SINGLE PROTEIN" \
  --max_results 5 \
  --output .agent/skills/db-chembl/examples/egfr_targets.json
...
python .agent/skills/db-chembl/scripts/query_chembl.py \
  ...
  --pchembl_min 5.0 \
  --max_results 5 \
  --output .agent/skills/db-chembl/examples/egfr_ic50_activities.json
```
