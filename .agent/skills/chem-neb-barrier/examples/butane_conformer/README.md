...
| File | Description |
|------|-------------|
| `anti_butane.xyz` | Anti conformation (dihedral 180°), generated by RDKit MMFF |
| `gauche_butane.xyz` | Gauche conformation (dihedral ~65°), generated by RDKit MMFF |
...
| `output/neb_path.xyz` | Full NEB path (XYZ trajectory) |
| `output/ts_neb.xyz` | Transition state structure |
