...
- [protein-prep](../protein-prep/SKILL.md) to generate `*_prepared.pdbqt`
- [ligand-prep](../ligand-prep/SKILL.md) to generate ligand `*.pdbqt` (consider multiple protomers/tautomers)
...
```bash
# Env: drugdisc-agent
python .agent/skills/docking-vina/scripts/compute_box_from_pdbqt.py \
