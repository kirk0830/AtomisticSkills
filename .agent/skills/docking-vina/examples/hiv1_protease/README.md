...
python .agent/skills/protein-prep/scripts/prepare_protein.py \
  ...
  --output_dir .agent/skills/docking-vina/examples/hiv1_protease/inputs/
...
# Step 3: Dock
python .agent/skills/docking-vina/scripts/run_docking.py \
  --receptor .agent/skills/docking-vina/examples/hiv1_protease/inputs/1HSG_prepared.pdbqt \
  --ligand .agent/skills/docking-vina/examples/hiv1_protease/inputs/indinavir/indinavir.pdbqt \
  ...
  --n_poses 5 \
  --seed 42 \
  --output_dir .agent/skills/docking-vina/examples/hiv1_protease/output/
```
