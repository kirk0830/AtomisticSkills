...
The in-house literature database consists of markdown (`.md`) files stored in the `.agent/workflows/` directory. Each file contains a workflow guide for a specific research topic, summarized from academic papers. 
...
```bash
grep -rn "^description:" .agent/workflows/
```
