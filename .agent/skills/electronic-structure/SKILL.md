...
```bash
# Env: base-agent
python .agent/skills/electronic-structure/scripts/plot_band_structure.py \
...
```bash
# Env: base-agent
python .agent/skills/electronic-structure/scripts/plot_dos.py \
    dos_results \
    --output dos.png
```
...
# 3. Plot results
# Env: base-agent
python .agent/skills/electronic-structure/scripts/plot_band_structure.py Si_bands --output Si_bands.png
```
...
# 3. Plot DOS
# Env: base-agent
python .agent/skills/electronic-structure/scripts/plot_dos.py Si_dos --output Si_dos.png
```
