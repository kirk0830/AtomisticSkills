...
```bash
# Env: base-agent
python .agent/skills/mat-kinetic-monte-carlo/scripts/build_lattice_from_structure.py \
...
```bash
# Env: base-agent
python .agent/skills/mat-kinetic-monte-carlo/scripts/validate_detailed_balance.py \
...
```bash
# Env: base-agent
python .agent/skills/mat-kinetic-monte-carlo/scripts/run_lattice_kmc.py \
    --config kmc_config.json
```
...
```bash
# Env: base-agent
python .agent/skills/mat-kinetic-monte-carlo/scripts/analyze_kmc_msd.py \
