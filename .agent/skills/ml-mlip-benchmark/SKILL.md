...
Use the `.agent/skills/ml-mlip-benchmark/scripts/run_benchmark.py` script to perform inference across the dataset and compute global error metrics.
...
```bash
conda run -n <MODEL-AGENT-ENV> python .agent/skills/ml-mlip-benchmark/scripts/run_benchmark.py \
...
```bash
conda run -n base-agent python .agent/skills/ml-mlip-benchmark/scripts/plot_benchmark.py \
...
python .agent/skills/ml-mlip-benchmark/examples/fetch_r2scan.py

# Env: mace-agent
# Benchmark MACE foundation potential
conda run -n mace-agent python .agent/skills/ml-mlip-benchmark/scripts/run_benchmark.py \
...
![MACE-MATPES-R2SCAN-0 Parity Plot](/home/bdeng/projects/AtomisticSkills/.agent/skills/ml-mlip-benchmark/examples/mace_parity.png)
![CHGNet-MatPES-r2SCAN-2025.2.10-2.7M Parity Plot](/home/bdeng/projects/AtomisticSkills/.agent/skills/ml-mlip-benchmark/examples/chgnet_parity.png)
![M3GNet-MatPES-r2SCAN-v2025.1 Parity Plot](/home/bdeng/projects/AtomisticSkills/.agent/skills/ml-mlip-benchmark/examples/m3gnet_parity.png)
![TensorNet-MatPES-r2SCAN-v2025.1 Parity Plot](/home/bdeng/projects/AtomisticSkills/.agent/skills/ml-mlip-benchmark/examples/tensornet_parity.png)
