...
```bash
# Env: base-agent
conda run -n base-agent python .agent/skills/ml-mlip-benchmark/examples/fetch_r2scan.py
```
...
conda run -n matgl-agent python .agent/skills/ml-mlip-benchmark/scripts/run_benchmark.py \
...
conda run -n base-agent python .agent/skills/ml-mlip-benchmark/scripts/plot_benchmark.py \
    ...
    --output_dir .agent/skills/ml-mlip-benchmark/examples/
