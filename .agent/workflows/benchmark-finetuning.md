...
1. **Choose a relevant foundation potential**
   ...
   - Refer to the `ml-foundation-potentials` skill (`.agent/skills/ml-foundation-potentials/SKILL.md`) to select an appropriate foundation potential.
...
2. **Sample the Potential Energy Surface (PES)**
   ...
   - For solid-state materials, refer to the `mat-sample-pes-by-md` skill (`.agent/skills/mat-sample-pes-by-md/SKILL.md`).
...
4. **Benchmark the foundation potential's accuracy**
   ...
   - Refer to the `ml-mlip-training` skill (`.agent/skills/ml-mlip-training/SKILL.md`) for benchmarking procedures to determine if fine-tuning is necessary.
...
5. **Perform fine-tuning (or distillation)**
   ...
   - Refer to the `ml-mlip-training` skill (`.agent/skills/ml-mlip-training/SKILL.md`) for instructions on setting up and executing the fine-tuning process.
