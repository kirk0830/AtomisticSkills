...
description: Rules to implement a workflow under `.agent/workflows/`
---

# Workflow Standards

All high-level research objectives in this project should be implemented as "Workflows" within the `.agent/workflows/` directory. This rule ensures consistency, discoverability, and reusability for the agent when addressing complex user requests.
...
Workflows are typically maintained as single markdown files in the `.agent/workflows/` directory:
