...
class TestMatGLPredictAtomicFeatures:
    ...
    def test_predict_atomic_features_chgnet(self, sample_ase_atoms, skip_if_wrong_env):
        ...
        wrapper = MatGLWrapper(model_name="CHGNet-MatPES-PBE-2025.2.10-2.7M-PES", device="cpu")
        wrapper.load()
...
class TestMatGLCalculator:
    ...
    def test_calculator_computes_energy_forces_stress(self, sample_ase_atoms, skip_if_wrong_env):
