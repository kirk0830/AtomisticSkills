...
class TestMACEPredictAtomicFeatures:
    ...
    def test_predict_atomic_features_returns_correct_format(
    ...
    def test_predict_atomic_features_with_file_path(
        self, tmp_cif_file, skip_if_wrong_env
    ):
    ...
    def test_feature_dimensions_consistent(self, skip_if_wrong_env):
        ...
        assert (
            result1["feature_dim"] == result2["feature_dim"]
...
class TestMACECalculator:
    ...
    def test_calculator_computes_energy_and_forces(
        self, sample_ase_atoms, skip_if_wrong_env
    ):
