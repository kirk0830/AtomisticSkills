...
print(
    f"  V_O^0 (E_F=0)   = {formation_energy(E_vac_q0, E_pristine, mu_O_rich, 0, 0):.4f} eV"
)
print(
    f"  V_O^+1 (E_F=0)  = {formation_energy(E_vac_q1, E_pristine, mu_O_rich, 1, 0):.4f} eV"
)
print(
    f"  V_O^+2 (E_F=0)  = {formation_energy(E_vac_q2, E_pristine, mu_O_rich, 2, 0):.4f} eV"
)
