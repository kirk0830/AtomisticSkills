...
def main():
    ...
    parser.add_argument(
        "--input", required=True, help="Path to structure file (traj or cif)"
    )
    parser.add_argument(
        "--initial", help="Path to initial crystalline structure for comparison"
    )
    ...
    plt.title("RDF Analysis: Amorphorization", fontsize=14)
