...
```bash
python .agents/skills/mat-phase-field-allen-cahn/scripts/run_grain_growth.py \
    --grid-size 50 \
    --radius 15 \
    --steps 150 \
    --dt 0.1 \
    --output .agents/skills/mat-phase-field-allen-cahn/examples/benchmark-grain/grain_growth.gif
```
