...
```bash
python .agents/skills/mat-phase-field-allen-cahn/scripts/run_dendrite_growth.py \
    --grid-size 300 \
    --steps 12000 \
    --dt 0.00005 \
    --output .agents/skills/mat-phase-field-allen-cahn/examples/benchmark-dendrite/dendrite.gif
```
