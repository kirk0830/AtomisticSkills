...
```bash
python .agents/skills/mat-phase-field-cahn-hilliard/scripts/run_spinodal_decomposition.py \
    --grid-size 100 \
    --dx 0.25 \
    --steps 200 \
    --dt 0.01 \
    --output .agents/skills/mat-phase-field-cahn-hilliard/examples/benchmark-spinodal/classic_spinodal.gif
```
