...
# Frenkel-Ladd Free Energy Skill

This skill calculates the absolute free energy of a crystalline solid using Frenkel-Ladd switching between a physical MLIP Hamiltonian and a harmonic Einstein-crystal reference.
...
```bash
# Env: mace-agent
python .agents/skills/mat-frenkel-ladd/scripts/run_frenkel_ladd.py \
...
# Env: mace-agent
python .agents/skills/mat-frenkel-ladd/scripts/run_frenkel_ladd.py \
    --structure .agents/skills/mat-frenkel-ladd/examples/Si_MACE/Si.cif \
    --name Si_demo \
    --calculator mace \
    --model-name MACE-OMAT-0-small \
    --temperature 300 \
